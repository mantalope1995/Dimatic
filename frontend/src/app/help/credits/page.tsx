      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-lg mb-8">
            Credits are Dimatic's standard unit of measurement for platform usage. Think of them as tokens that power your AI agents - the more complex or lengthy the task, the more credits it requires.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-6">
            Dimatic uses two types of credits to give you flexibility in how you manage your usage:
          </p>
        ...
        <section>
          ...
          <p className="mb-6">
            There are several ways to obtain credits in Dimatic:
          </p>
        ...
        <section>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            ...
            <Button
              variant="outline"
              className="gap-2"
              onClick={() => window.open('https://discord.gg/dimatic', '_blank')}
            >
