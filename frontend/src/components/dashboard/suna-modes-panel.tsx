...
const modes: Mode[] = [
  ...
  },
  {
    ...
    samplePrompts: [
      ...
      'Analyse 50K customer reviews and visualise sentiment trends over time',
      ...
      'Analyse website traffic data and visualise conversion funnels',
  ...
  //   },
  {
    ...
    samplePrompts: [
      'Analyse emerging trends in quantum computing and potential business applications',
      ...
      'Analyse consumer sentiment towards sustainable fashion brands',
