...
Dimatic (formerly Kortix) is a modern Next.js 15 application featuring AI agent management, real-time collaboration, and comprehensive business functionality. The app uses TypeScript, Tailwind CSS v4, and Supabase for authentication and database operations.
