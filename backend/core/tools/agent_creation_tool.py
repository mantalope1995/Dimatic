        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "agentpress_tools": {
                        "type": "object",
                        "description": "Configuration for AgentPress tools. Each key is a tool name, value is boolean for enabled/disabled. Available tools: sb_shell_tool, sb_files_tool, web_search_tool, browser_tool, data_providers_tool, native vision capabilities, etc.",
