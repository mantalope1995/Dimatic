...
from core.admin.obot_admin_api import router as obot_admin_router
...
api_router.include_router(obot_admin_router)
...
from core.obot import api as obot_api
api_router.include_router(obot_api.router)
